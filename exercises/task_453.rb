...
scores = { "rating" => 64, "order" => 96, "entry" => 73, "item" => 89, "comment" => 83, "tag" => 61, "report" => 75 }

puts "All scores:"
scores.each { |name, score| puts "  \#{name.ljust(12)} \#{score}" }

passing  = scores.select { |_, v| v >= 65 }
failing  = scores.reject { |_, v| v >= 65 }
top      = scores.max_by { |_, v| v }
lowest   = scores.min_by { |_, v| v }
average  = scores.values.sum.to_f / scores.size

puts "Passing (>=65)  : \#{passing.keys.inspect}"

...
items = [
  HotelReservation.new("category_a", 10),
  HotelReservation.new("category_b", 22),
  HotelReservation.new("category_c", 71),
  HotelReservation.new("category_d", 5),
]
